...
class DDPG(object):
    ...
    def update_policy(self):
        ...
        next_action = self.actor_target(to_tensor(next_state_batch, volatile=True))
...
#        value_loss = criterion(q_batch, target_q_batch)
        value_loss = F.smooth_l1_loss(q_batch, target_q_batch)
        value_loss.backward()
        self.critic_optim.step()

        print ("updated by value_loss: ", value_loss)
